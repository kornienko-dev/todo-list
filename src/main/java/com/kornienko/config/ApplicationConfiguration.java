...
@EnableJpaRepositories(basePackages = "com.kornienko.dao")
public class ApplicationConfiguration {
    ...
    private Properties additionalProperties() {
        ...
        properties.setProperty(SchemaToolingSettings.HBM2DDL_AUTO, "validate");
        properties.setProperty(JdbcSettings.SHOW_SQL, "true");
        properties.setProperty(JdbcSettings.FORMAT_SQL, "true");
        properties.setProperty(JdbcSettings.HIGHLIGHT_SQL, "true");
